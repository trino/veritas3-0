            ...
            <input type="hidden" name="profile_id" value="<?php if(isset($_GET['p_id']))echo $_GET['p_id'];else echo "0";?>" />
 			<div class="name form-group">
                ...
                <div class="input-icon">
                 <input type="text" class="form-control" name="surname" placeholder="Surname" value="<?php if($form)echo $form['surname'];?>" >
                 </div>
                 </div>
 				<div class="col-md-2 form-group"></div>
 				<div class="col-md-4 form-group">
                 <div class="input-icon"><input type="text" name="given" class="form-control" placeholder="Given" value="<?php if($form)echo $form['given'];?>">
                 </div>
                 </div>
 			</div>
 			...
 			<div class="">
 				<div class="hire">
 					...
 					<div class="col-md-4 form-group">
                     <div class="input-icon">
                     <input type="text" class="form-control" name="h_date" placeholder="MM/DD/YYYY" value="<?php if($form)echo $form['h_date'];?>"></div>
 				</div>
                </div>
 				<div class="review">
 					<label for="review" class="control-label col-md-2">Review Date:</label>
 					<div class="col-md-4 form-group">
                      <div class="input-icon"><input type="text" class="form-control" name="r_date" placeholder="MM/DD/YYYY" value="<?php if($form)echo $form['r_date'];?>"></div>
 				</div>
                </div>
 			</div>
 			<div class="supervisor">
 				...
 				<div class="supervisor-radio col-md-10 form-group" style="padding:0;">
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Richard Chilvers" <?php if($form && $form['supervisor']=='Richard Chilvers')echo "checked";?>> Richard Chilvers</div>
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Nelson Ralph" <?php if($form && $form['supervisor']=='Nelson Ralph')echo "checked";?>> Nelson Ralph	</div>
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Gary Martin" <?php if($form && $form['supervisor']=='Gary Martin')echo "checked";?>> Gary Martin</div>		
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Mike Ruehl" <?php if($form && $form['supervisor']=='Mike Ruehl')echo "checked";?>> Mike Ruehl</div>	
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Michael Torrance" <?php if($form && $form['supervisor']=='Michael Torrance')echo "checked";?>> Michael Torrance</div>
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Matt Bancroft" <?php if($form && $form['supervisor']=='Matt Bancroft')echo "checked";?>> Matt Bancroft</div>	
 				</div>
 			</div>
 			<div class="clearfix"></div>
 			...
 			<div class="hr col-md-12">
 				...
 				<div class="hr4">
 					...
 					<div class=" form-group">
 						<textarea name="hr3_ans" class="form-control"><?php if($form)echo $form['hr3_ans'];?></textarea>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr4">
 					...
 					<div class="hr5-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr4" value="yes" <?php if($form && $form['hr4']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr4" value="no" <?php if($form && $form['hr4']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr5">
 				...
 				<div class="hr13">
 					...
 					<div class=" form-group">
 						<textarea name="hr13" class="form-control"><?php if($form)echo $form['hr13'];?></textarea>
 					</div>
 				</div>
 			</div>
 			...
 			<div class="rs col-md-12">
 				...
 				<div class="rs1">
 					...
 					<div class="rs1-radio col-md-12 form-group" style="padding:0;">
 						<div class="col-md-2" style="padding:0;"><input type="radio" name="h1" value="super" <?php if($form && $form['h1']=='super')echo "checked";?>>Supervisor</div>
 						...
 						<div class="col-md-4" style="padding:0;">
 							...
 							<div class="input-icon">	<input type="text" name="h1_other" class="form-control" value="<?php if($form)echo $form['h1_other'];?>"></div>
 							</div>
 						</div>
 					</div>
 				</div>
 				...
 				<div class="rs11">
 					...
 					<div class="rs11-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-4"><input type="radio" name="h8" value="poor" <?php if($form && $form['h8']=='poor')echo "checked";?>>Poor</div>
 						<div class="col-md-4"><input type="radio" name="h8" value="fair" <?php if($form && $form['h8']=='fair')echo "checked";?>>Fair</div>
 						<div class="col-md-4"><input type="radio" name="h8" value="excellent" <?php if($form && $form['h8']=='excellent')echo "checked";?>>Excellent</div>
 					</div>
 				</div>
 				...
 				<div class="jst col-md-12">
 					...
 					<div class="jst3">
 						...
 						<div class="jst3-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="jst3" value="yes" <?php if($form && $form['jst3']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="jst3" value="no" <?php if($form && $form['jst3']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="jst4">
 						...
 						<div class="jst4-radio col-md-4 form-group" style="padding:0;">
                            ...
                            <div class="input-icon"> <input type="text" name="jst4" class="form-control" value="<?php if($form)echo $form['jst4'];?>"></div></div>
 						</div>
 					</div>
 					...
 					<div class="jst7">
                         ...
                         <div class="col-md-12 form-group" style="padding:0;">
 							<textarea name="jst7_why" class="form-control"><?php if($form)echo $form['jst7_why'];?></textarea>
 						</div>
 					</div>
 					<div class="jst8">
 						...
 						<div class="col-md-12 form-group" style="padding:0;">
 							<textarea name="jst8" class="form-control"><?php if($form)echo $form['jst8'];?></textarea>
 						</div>
 					</div>
 					<div class="jst9">
 						...
 						<div class="col-md-12 form-group" style="padding:0;">
 							<textarea name="jst9" class="form-control"><?php if($form)echo $form['jst9'];?></textarea>
 						</div>
 					</div>
 					<div class="jst10">
 						...
 						<div class="col-md-12 form-group" style="padding:0;">
 							<textarea name="jst10" class="form-control"><?php if($form)echo $form['jst10'];?></textarea>
 						</div>
 					</div>
 					<div class="jst11">
 						...
 						<div class="col-md-12 form-group" style="padding:0;">
 							<textarea name="jst11" class="form-control"><?php if($form)echo $form['jst11'];?></textarea>
 						</div>
 					</div>
 				...
 				<div class="coc col-md-12">
 					...
 					<div class="">
 						...
 						<div class="col-md-3 form-group"><div class="input-icon"><input type="text" class="form-control" name="employee" placeholder="Employee" value="<?php if($form)echo $form['employee'];?>"></div>
 						</div>
                         <div class="col-md-2"></div>
 					...
 					<div class="">
 						<div class="col-md-2"></div>
 						<div class="col-md-3">
 							<div class="input-icon"><input type="text" class="form-control" name="hr_representative" placeholder="H.R. Representative" value="<?php if($form)echo $form['hr_representative'];?>"></div>
 						     </div>
                              	<div class="col-md-2"></div>
