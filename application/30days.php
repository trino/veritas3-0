            ...
            <input type="hidden" name="profile_id" value="<?php if(isset($_GET['p_id']))echo $_GET['p_id'];else echo "0";?>" />
 			...
 			<div class="">
 				<div class="hire">
 					...
 					<div class="col-md-4 form-group">
                     <div class="input-icon">
                     <input type="text" class="form-control" name="h_date" placeholder="MM/DD/YYYY" value="<?php if(isset($form) && isset($_GET['form_id']))echo $form['h_date'];?>"></div>
 				</div>
                </div>
 				<div class="review">
 					<label for="review" class="control-label col-md-2">Review Date:</label>
 					<div class="col-md-4 form-group">
                      <div class="input-icon"><input type="text" class="form-control" name="r_date" placeholder="MM/DD/YYYY" value="<?php if(isset($form) && isset($_GET['form_id']))echo $form['r_date'];?>"></div>
 				</div>
                </div>
 			</div>
 			<div class="supervisor">
 				...
 				<div class="supervisor-radio col-md-10 form-group" style="padding:0;">
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Richard Chilvers" <?php if(isset($form) && $form['supervisor']=='Richard Chilvers')echo "checked";?>> Richard Chilvers</div>
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Nelson Ralph" <?php if(isset($form) && $form['supervisor']=='Nelson Ralph')echo "checked";?>> Nelson Ralph	</div>
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Gary Martin" <?php if(isset($form) && $form['supervisor']=='Gary Martin')echo "checked";?>> Gary Martin</div>		
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Mike Ruehl" <?php if(isset($form) && $form['supervisor']=='Mike Ruehl')echo "checked";?>> Mike Ruehl</div>	
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Michael Torrance" <?php if(isset($form) && $form['supervisor']=='Michael Torrance')echo "checked";?>> Michael Torrance</div>
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Matt Bancroft" <?php if(isset($form) && $form['supervisor']=='Matt Bancroft')echo "checked";?>> Matt Bancroft</div>	
 				</div>
 			</div>
 			<div class="clearfix"></div>
 			...
 			<div class="hr col-md-12">
 				...
 				<div class="hr1">
 					...
 					<div class="hr1-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr1" value="yes" <?php if(isset($form) && $form['hr1']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr1" value="no" <?php if(isset($form) && $form['hr1']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr2">
 				...
 				<div class="hr3">
 					...
 					<div class="hr3-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr3" value="yes" <?php if(isset($form) && $form['hr3']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr3" value="no" <?php if(isset($form) && $form['hr3']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr4">
 				...
 				<div class="hr4">
 					...
 					<div class="hr5-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr4" value="yes" <?php if(isset($form) && $form['hr4']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr4" value="no" <?php if(isset($form) && $form['hr4']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr5">
 					...
 					<div class="hr6-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr5" value="yes" <?php if(isset($form) && $form['hr5']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr5" value="no" <?php if(isset($form) && $form['hr5']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr6">
 					...
 					<div class="hr6-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr6" value="yes" <?php if(isset($form) && $form['hr6']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr6" value="no" <?php if(isset($form) && $form['hr6']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr7">
 					...
 					<div class="hr7-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr7" value="yes" <?php if(isset($form) && $form['hr7']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr7" value="no" <?php if(isset($form) && $form['hr7']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr8">
 					...
 					<div class="hr8-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr8" value="yes" <?php if(isset($form) && $form['hr8']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr8" value="no" <?php if(isset($form) && $form['hr8']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr9">
 					...
 					<div class="hr9-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr9" value="yes" <?php if(isset($form) && $form['hr9']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr9" value="no" <?php if(isset($form) && $form['hr9']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr10">
 					...
 					<div class="hr10-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr10" value="yes" <?php if(isset($form) && $form['hr10']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr10" value="no" <?php if(isset($form) && $form['hr10']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr11">
 					...
 					<div class="hr11-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr11" value="yes" <?php if(isset($form) && $form['hr11']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr11" value="no" <?php if(isset($form) && $form['hr11']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr12">
 					...
 					<div class="hr12-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr12" value="yes" <?php if(isset($form) && $form['hr12']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr12" value="no" <?php if(isset($form) && $form['hr12']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr13">
 			...
 			<div class="rs col-md-12">
 				...
 				<div class="rs1">
 					...
 					<div class="rs1-radio col-md-12 form-group" style="padding:0;">
 						<div class="col-md-2" style="padding:0;"><input type="radio" name="h1" value="super" <?php if(isset($form) && $form['h1']=='super')echo "checked";?>>Supervisor</div>
 						<div class="col-md-2" style="padding:0;"><input type="radio" name="h1" value="fellow" <?php if(isset($form) && $form['h1']=='fellow')echo "checked";?>>Fellow Colleague</div>
 						<div class="col-md-2" style="padding:0;"><input type="radio" name="h1" value="ats" <?php if(isset($form) && $form['h1']=='ats')echo "checked";?>>A.T.S</div>
 						<div class="col-md-2" style="padding:0;"><input type="radio" name="h1" value="hr" <?php if(isset($form) && $form['h1']=='hr')echo "checked";?>>H.R.</div>
 				...
 				<div class="rs2">
 					...
 					<div class="rs2-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-4"><input type="radio" name="h2" value="poor" <?php if(isset($form) && $form['h2']=='poor')echo "checked";?>>Poor</div>
 						<div class="col-md-4"><input type="radio" name="h2" value="fair" <?php if(isset($form) && $form['h2']=='fair')echo "checked";?>>Fair</div>
 						<div class="col-md-4"><input type="radio" name="h2" value="excellent" <?php if(isset($form) && $form['h2']=='excellent')echo "checked";?>>Excellent</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="rs3">
 				...
 				<div class="rs4">
 					...
 					<div class="rs4-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-4"><input type="radio" name="h3" value="poor" <?php if(isset($form) && $form['h3']=='poor')echo "checked";?>>Poor</div>
 						<div class="col-md-4"><input type="radio" name="h3" value="fair" <?php if(isset($form) && $form['h3']=='fair')echo "checked";?>>Fair</div>
 						<div class="col-md-4"><input type="radio" name="h3" value="excellent" <?php if(isset($form) && $form['h3']=='excellent')echo "checked";?>>Excellent</div>
 					</div>
 				</div>
 				...
 				<div class="rs6">
 					...
 					<div class="rs6-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-4"><input type="radio" name="h4" value="poor" <?php if(isset($form) && $form['h4']=='poor')echo "checked";?>>Poor</div>
 						<div class="col-md-4"><input type="radio" name="h4" value="fair" <?php if(isset($form) && $form['h4']=='fair')echo "checked";?>>Fair</div>
 						<div class="col-md-4"><input type="radio" name="h4" value="excellent" <?php if(isset($form) && $form['h4']=='excellent')echo "checked";?>>Excellent</div>
 					</div>
 				</div>
 				...
 				<div class="rs8">
 					...
 					<div class="rs8-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-4"><input type="radio" name="h5" value="yes" <?php if(isset($form) && $form['h5']=='yes')echo "checked";?>>Yes</div>
 						<div class="col-md-4"><input type="radio" name="h5" value="no" <?php if(isset($form) && $form['h5']=='no')echo "checked";?>>No</div>
 					</div>
 				</div>
 				<div class="rs9">
 					...
 					<div class="rs9-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-4"><input type="radio" name="h6" value="poor" <?php if(isset($form) && $form['h6']=='poor')echo "checked";?>>Poor</div>
 						<div class="col-md-4"><input type="radio" name="h6" value="fair" <?php if(isset($form) && $form['h6']=='fair')echo "checked";?>>Fair</div>
 						<div class="col-md-4"><input type="radio" name="h6" value="excellent" <?php if(isset($form) && $form['h6']=='excellent')echo "checked";?>>Excellent</div>
 					</div>
 				</div>
 				<div class="rs10">
 					...
 					<div class="rs10-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-4"><input type="radio" name="h7" value="poor" <?php if(isset($form) && $form['h7']=='poor')echo "checked";?>>Poor</div>
 						<div class="col-md-4"><input type="radio" name="h7" value="fair" <?php if(isset($form) && $form['h7']=='fair')echo "checked";?>>Fair</div>
 						<div class="col-md-4"><input type="radio" name="h7" value="excellent" <?php if(isset($form) && $form['h7']=='excellent')echo "checked";?>>Excellent</div>
 					</div>
 				</div>
 				...
 				<div class="rs11">
 					...
 					<div class="rs11-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-4"><input type="radio" name="h8" value="poor" <?php if(isset($form) && $form['h8']=='poor')echo "checked";?>>Poor</div>
 						<div class="col-md-4"><input type="radio" name="h8" value="fair" <?php if(isset($form) && $form['h8']=='fair')echo "checked";?>>Fair</div>
 						<div class="col-md-4"><input type="radio" name="h8" value="excellent" <?php if(isset($form) && $form['h8']=='excellent')echo "checked";?>>Excellent</div>
 					</div>
 				</div>
 				...
 				<div class="jst col-md-12">
 					...
 					<div class="jst1">
 						...
 						<div class="jst1-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="jst1" value="yes" <?php if(isset($form) && $form['jst1']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="jst1" value="no" <?php if(isset($form) && $form['jst1']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="jst2">
 						...
 						<div class="jst2-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="jst2" value="yes" <?php if(isset($form) && $form['jst2']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="jst2" value="no" <?php if(isset($form) && $form['jst2']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="jst3">
 						...
 						<div class="jst3-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="jst3" value="yes" <?php if(isset($form) && $form['jst3']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="jst3" value="no" <?php if(isset($form) && $form['jst3']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="jst4">
 					...
 					<div class="jst5">
 						...
 						<div class="jst5-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="jst5" value="yes" <?php if(isset($form) && $form['jst5']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="jst5" value="no" <?php if(isset($form) && $form['jst5']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					...
 					<div class="jst6">
 						...
 						<div class="jst6-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="jst6" value="yes" <?php if(isset($form) && $form['jst6']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="jst6" value="no" <?php if(isset($form) && $form['jst6']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="jst7">
 						...
 						<div class="jst6-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="jst7" value="yes" <?php if(isset($form) && $form['jst7']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="jst7" value="no" <?php if(isset($form) && $form['jst7']=='no')echo "checked";?>>No</div>
 						</div>
                         <div class="col-md-12 form-group" style="padding:0;">
 				...
 				<div class="ohs col-md-12">
 					...
 					<div class="ohs1">
 						...
 						<div class="ohs1-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="ohs1" value="yes" <?php if(isset($form) && $form['ohs1']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="ohs1" value="no" <?php if(isset($form) && $form['ohs1']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="ohs2">
 						...
 						<div class="ohs2-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="ohs2" value="yes" <?php if(isset($form) && $form['ohs2']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="ohs2" value="no" <?php if(isset($form) && $form['ohs2']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="ohs3">
 						...
 						<div class="ohs3-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="ohs3" value="yes" <?php if(isset($form) && $form['ohs3']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="ohs3" value="no" <?php if(isset($form) && $form['ohs3']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="ohs4">
 						...
 						<div class="ohs4-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="ohs4" value="yes" <?php if(isset($form) && $form['ohs4']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="ohs4" value="no" <?php if(isset($form) && $form['ohs4']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="ohs5">
 						...
 						<div class="ohs5-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="ohs5" value="yes" <?php if(isset($form) && $form['ohs5']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="ohs5" value="no" <?php if(isset($form) && $form['ohs5']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="ohs6">
 						...
 						<div class="ohs6-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="ohs6" value="yes" <?php if(isset($form) && $form['ohs6']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="ohs6" value="no" <?php if(isset($form) && $form['ohs6']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="ohs7">
 						...
 						<div class="ohs7-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="ohs7" value="yes" <?php if(isset($form) && $form['ohs7']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="ohs7" value="no" <?php if(isset($form) && $form['ohs7']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="ohs8">
 						...
 						<div class="ohs8-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="ohs8" value="yes" <?php if(isset($form) && $form['ohs8']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="ohs8" value="no" <?php if(isset($form) && $form['ohs8']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
 					<div class="ohs9">
 						...
 						<div class="ohs9-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-6"><input type="radio" name="ohs9" value="yes" <?php if(isset($form) && $form['ohs9']=='yes')echo "checked";?>>Yes</div>
 							<div class="col-md-6"><input type="radio" name="ohs9" value="no" <?php if(isset($form) && $form['ohs9']=='no')echo "checked";?>>No</div>
 						</div>
 					</div>
