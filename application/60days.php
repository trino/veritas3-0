 		...
 		<form action="<?php echo $webroot;?>rapid/days/60"  method="post" class="formz" >
            <input type="hidden" name="profile_id" value="<?php if(isset($_GET['p_id']))echo $_GET['p_id']; else echo "0";?>" />
 			...
 			<div class="hire form-group">
 				...
 				<div class="col-md-4 form-group"> <div class="input-icon"><input type="text" class="form-control" name="h_date" placeholder="MM/DD/YYYY" value="<?php if(isset($form) && isset($_GET['form_id']))echo $form['h_date'];?>"></div>
 			</div>
            </div>
 			<div class="review form-group">
 				<label for="review" class="control-label col-md-2 form-group">Review Date:</label>
 				<div class="col-md-4 form-group"> <div class="input-icon"><input type="text" class="form-control" name="r_date" placeholder="MM/DD/YYYY" value="<?php if(isset($form) && isset($_GET['form_id']))echo $form['r_date'];?>"></div>
 			</div>
 			</div>
            </div>
 			<div class="supervisor form-group">
 				...
 				<div class="supervisor-radio col-md-10 form-group" style="padding:0;">
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Mario Ross" <?php if(isset($form) && isset($_GET['form_id']) && $form['supervisor']=='Mario Ross')echo "checked";?>> Mario Ross</div>
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Roy Ralph"  <?php if(isset($form) && isset($_GET['form_id']) && $form['supervisor']=='Roy Ralph')echo "checked";?>> Roy Ralph</div>
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Gord Ade"  <?php if(isset($form) && isset($_GET['form_id']) && $form['supervisor']=='Gord Ade')echo "checked";?>> Gord Ade</div>	
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Mark Dunlop"  <?php if(isset($form) && isset($_GET['form_id']) && $form['supervisor']=='Mark Dunlop')echo "checked";?>> Mark Dunlop</div>	
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Henry Diego"  <?php if(isset($form) && isset($_GET['form_id']) && $form['supervisor']=='Henry Diego')echo "checked";?>> Henry Diego</div>
 					<div class="col-md-2"><input type="radio" name="supervisor" value="Dave Halliday"  <?php if(isset($form) && isset($_GET['form_id']) && $form['supervisor']=='Dave Halliday')echo "checked";?>> Dave Halliday</div>
 					<div class="col-md-4"><input type="radio" name="supervisor" value="Brett Whitehead"  <?php if(isset($form) && isset($_GET['form_id']) && $form['supervisor']=='Brett Whitehead')echo "checked";?>> Brett Whitehead</div>	
 				</div>
 			</div>
 			<div class="clearfix"></div>
 			...
 			<div class="hr col-md-12">
 				...
 				<div class="hr1">
 					...
 					<div class="hr1-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr1" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr1']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr1" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr1']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="hr2">
 				...
 				<div class="hr3">
 					...
 					<div class="hr3-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr3" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr3']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr3" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr3']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="hr4">
 				...
 				<div class="hr5">
 					...
 					<div class="hr5-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr5" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr5']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr5" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr5']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="hr6">
 					...
 					<div class="hr6-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr6" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr6']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr6" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr6']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="hr7">
 					...
 					<div class="hr7-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr7" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr7']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr7" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr7']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="hr8">
 					...
 					<div class="hr8-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr8" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr8']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr8" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr8']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="hr9">
 					...
 					<div class="hr9-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr9" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr9']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr9" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr9']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="hr10">
 					...
 					<div class="hr10-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr10" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr10']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr10" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr10']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="hr11">
 					...
 					<div class="hr11-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr11" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr11']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr11" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr11']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="hr12">
 					...
 					<div class="hr12-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr12" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr12']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr12" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr12']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="hr13">
 					...
 					<div class="hr13-radio col-md-4 form-group" style="padding:0;">
 						<div class="col-md-6"><input type="radio" name="hr13" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr13']=='yes')echo "checked";?>> Yes</div>
 						<div class="col-md-6"><input type="radio" name="hr13" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['hr13']=='no')echo "checked";?>> No</div>
 					</div>
 				</div>
 				<div class="clearfix"></div>
 				<div class="hr14">
 				...
 				<div class="rs col-md-12">
 					...
 					<div class="h1s">
 						...
 						<div class="h1-radio col-md-12 form-group" style="padding:0;">
 							<div class="col-md-2" style="padding:0;"><input type="radio" name="h1" value="supervisor"  <?php if(isset($form) && isset($_GET['form_id']) && $form['supervisor']=='yes')echo "checked";?>> Supervisor</div>
 							<div class="col-md-2" style="padding:0;"><input type="radio" name="h1" value="fellow"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h1']=='fellow')echo "checked";?>> Fellow Colleague</div>
 							<div class="col-md-2" style="padding:0;"><input type="radio" name="h1" value="ats"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h1']=='ats')echo "checked";?>> A.T.S</div>
 							<div class="col-md-2" style="padding:0;"><input type="radio" name="h1" value="hr"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h1']=='hr')echo "checked";?>> H.R.</div>
 					...
 					<div class="h2s">
 						...
 						<div class="h2-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-4"><input type="radio" name="h2" value="poor"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h2']=='poor')echo "checked";?>> Poor</div>
 							<div class="col-md-4"><input type="radio" name="h2" value="fair"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h2']=='fair')echo "checked";?>> Fair</div>
 							<div class="col-md-4"><input type="radio" name="h2" value="excellent"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h2']=='excellent')echo "checked";?>> Excellent</div>
 						</div>
 					</div>
 					...
 					<div class="rs4">
 						...
 						<div class="rs4-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-4"><input type="radio" name="h3" value="poor"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h3']=='poor')echo "checked";?>> Poor</div>
 							<div class="col-md-4"><input type="radio" name="h3" value="fair"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h3']=='fair')echo "checked";?>> Fair</div>
 							<div class="col-md-4"><input type="radio" name="h3" value="excellent"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h3']=='excellent')echo "checked";?>> Excellent</div>
 						</div>
 					</div>
 					...
 					<div class="rs6">
 						...
 						<div class="rs6-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-4"><input type="radio" name="h4" value="poor"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h4']=='poor')echo "checked";?>> Poor</div>
 							<div class="col-md-4"><input type="radio" name="h4" value="fair"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h4']=='fair')echo "checked";?>> Fair</div>
 							<div class="col-md-4"><input type="radio" name="h4" value="excellent"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h4']=='excellent')echo "checked";?>> Excellent</div>
 						</div>
 					</div>
 					...
 					<div class="rs8">
 						...
 						<div class="rs8-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-4"><input type="radio" name="h5" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h5']=='yes')echo "checked";?>> Yes</div>
 							<div class="col-md-4"><input type="radio" name="h5" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h5']=='no')echo "checked";?>> No</div>
 						</div>
 					</div>
 					<div class="rs9">
 						...
 						<div class="rs9-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-4"><input type="radio" name="h6" value="poor"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h6']=='poor')echo "checked";?>> Poor</div>
 							<div class="col-md-4"><input type="radio" name="h6" value="fair"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h6']=='fair')echo "checked";?>> Fair</div>
 							<div class="col-md-4"><input type="radio" name="h6" value="excellent"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h6']=='excellent')echo "checked";?>> Excellent</div>
 						</div>
 					</div>
 					<div class="rs10">
 						...
 						<div class="rs10-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-4"><input type="radio" name="h7" value="poor"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h7']=='poor')echo "checked";?>> Poor</div>
 							<div class="col-md-4"><input type="radio" name="h7" value="fair"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h7']=='fair')echo "checked";?>> Fair</div>
 							<div class="col-md-4"><input type="radio" name="h7" value="excellent"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h7']=='excellent')echo "checked";?>> Excellent</div>
 						</div>
 					</div>
 					...
 					<div class="rs11">
 						...
 						<div class="rs11-radio col-md-4 form-group" style="padding:0;">
 							<div class="col-md-4"><input type="radio" name="h8" value="poor"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h6']=='poor')echo "checked";?>> Poor</div>
 							<div class="col-md-4"><input type="radio" name="h8" value="fair"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h6']=='fair')echo "checked";?>> Fair</div>
 							<div class="col-md-4"><input type="radio" name="h8" value="excellent"  <?php if(isset($form) && isset($_GET['form_id']) && $form['h6']=='excellent')echo "checked";?>> Excellent</div>
 						</div>
 					</div>
 					...
 					<div class="jst col-md-12">
 						...
 						<div class="jst1">
 							...
 							<div class="jst1-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="jst1" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst1']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="jst1" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst1']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="jst2">
 							...
 							<div class="jst2-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="jst2" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst2']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="jst2" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst2']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="jst3">
 						...
 						<div class="jst4">
 							...
 							<div class="jst4-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="jst4" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst4']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="jst4" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst4']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						...
 						<div class="jst5">
 							...
 							<div class="jst5-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="jst5" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst5']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="jst5" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst5']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						...
 						<div class="jst6">
 							...
 							<div class="jst6-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="jst6" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst6']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="jst6" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst6']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="jst7">
 							...
 							<div class="jst7-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="jst7" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst7']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="jst7" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst7']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="jst8">
 							...
 							<div class="jst8-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="jst8" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst8']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="jst8" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst8']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="jst9">
 							...
 							<div class="jst9-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="jst9" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst9']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="jst9" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst9']=='no')echo "checked";?>> No</div>
 							</div>
 							<div class="col-md-12 form-group" style="padding:0;">
 						...
 						<div class="jst10">
 							...
 							<div class="jst10-radio col-md-12 form-group" style="padding:0;">
 								<div class="col-md-4"><input type="radio" name="jst10" value="oneon"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst10']=='oneon')echo "checked";?>> One-on-one with trainer</div>
 								<div class="col-md-4"><input type="radio" name="jst10" value="warehouse"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst10']=='warehouse')echo "checked";?>> Warehouse Training</div>
 								<div class="col-md-4"><input type="radio" name="jst10" value="driving"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst10']=='driving')echo "checked";?>> Driving training</div>
 							</div>
 							<div class="col-md-12 form-group" style="padding:0;">
 						...
 						<div class="jst11">
 							...
 							<div class="jst11-radio col-md-12 form-group" style="padding:0;">
 								<div class="col-md-4"><input type="radio" name="jst11" value="oneon"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst11']=='oneon')echo "checked";?>> One-on-one with trainer</div>
 								<div class="col-md-4"><input type="radio" name="jst11" value="warehouse"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst11']=='warehouse')echo "checked";?>> Warehouse Training</div>
 								<div class="col-md-4"><input type="radio" name="jst11" value="driving"  <?php if(isset($form) && isset($_GET['form_id']) && $form['jst11']=='driving')echo "checked";?>> Driving training</div>
 							</div>
 							<div class="col-md-12 form-group" style="padding:0;">
 						...
 						<div class="jst13">
                            ...
                            <?php if(isset($form) && isset($_GET['form_id']))
                            {
                               $checks = explode(",",$form['jst13']); 
                                ...
                                $checks = array(); 
                            ?>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="divr"  <?php if(in_array('divr', $checks))echo "checked";?>> D.I.V.R</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="time"  <?php if(in_array('time', $checks))echo "checked";?>> Time Sheets</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="fueling"  <?php if(in_array('fueling', $checks))echo "checked";?>> Fueling Power Units</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="bid"  <?php if(in_array('bid', $checks))echo "checked";?>> Bid Process</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="fuel"  <?php if(in_array('fuel', $checks))echo "checked";?>> Fuel Sheets</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="reefer"  <?php if(in_array('reefer', $checks))echo "checked";?>> Reefer Training</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="parking"  <?php if(in_array('parking', $checks))echo "checked";?>> Parking Tickets</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="policies"  <?php if(in_array('policies', $checks))echo "checked";?>> Policies & Procedures</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="backing"  <?php if(in_array('backing', $checks))echo "checked";?>> Backing</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="voicemail"  <?php if(in_array('voicemail', $checks))echo "checked";?>> Voicemail</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="hand"  <?php if(in_array('hand', $checks))echo "checked";?>> Hand Carts</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="credits"  <?php if(in_array('credits', $checks))echo "checked";?>> Credits</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="sick"  <?php if(in_array('sick', $checks))echo "checked";?>> Sick-line Proceduer</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="coupling"  <?php if(in_array('coupling', $checks))echo "checked";?>> Coupling & Uncoupling</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="damages"  <?php if(in_array('damages', $checks))echo "checked";?>> Damages</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="customer"  <?php if(in_array('customer', $checks))echo "checked";?>> Customer Service</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="log"  <?php if(in_array('log', $checks))echo "checked";?>> Logbooks</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="fourzero"  <?php if(in_array('fourzero', $checks))echo "checked";?>> 407</div>
 								<div class="">
 									<div class="col-md-4"> <input type="checkbox" name="train[]" value="wd"  <?php if(in_array('wd', $checks))echo "checked";?>>Wash Day</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="ap"  <?php if(in_array('ap', $checks))echo "checked";?>> Attendance Policy</div>
 								<div class="col-md-4"></div>
 								</div>
 								<div class="">
 									<div class="col-md-4"> <input type="checkbox" name="train[]" value="htsf"  <?php if(in_array('htsf', $checks))echo "checked";?>> How to Slide a fifth Wheel</div>
 								<div class="col-md-4"> <input type="checkbox" name="train[]" value="dqp"  <?php if(in_array('dqp', $checks))echo "checked";?>> Driver's Qualification Policy</div>
 								<div class="col-md-4"></div>
 								</div>
 					...
 					<div class="ohs col-md-12">
 						...
 						<div class="ohs1">
 							...
 							<div class="ohs1-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="ohs1" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs1']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="ohs1" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs1']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="ohs2">
 							...
 							<div class="ohs2-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="ohs2" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs2']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="ohs2" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs2']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="ohs3">
 							...
 							<div class="ohs3-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="ohs3" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs3']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="ohs3" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs3']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="ohs4">
 							...
 							<div class="ohs4-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="ohs4" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs4']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="ohs4" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs4']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="ohs5">
 							...
 							<div class="ohs5-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="ohs5" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs5']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="ohs5" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs5']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="ohs6">
 							...
 							<div class="ohs6-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="ohs6" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs6']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="ohs6" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs6']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="ohs7">
 							...
 							<div class="ohs7-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="ohs7" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs7']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="ohs7" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs7']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="ohs8">
 							...
 							<div class="ohs8-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="ohs8" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs8']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="ohs8" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs8']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 						<div class="ohs9">
 							...
 							<div class="ohs9-radio col-md-4 form-group" style="padding:0;">
 								<div class="col-md-6"><input type="radio" name="ohs9" value="yes"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs9']=='yes')echo "checked";?>> Yes</div>
 								<div class="col-md-6"><input type="radio" name="ohs9" value="no"  <?php if(isset($form) && isset($_GET['form_id']) && $form['ohs9']=='no')echo "checked";?>> No</div>
 							</div>
 						</div>
 					...
 					<div class="coc col-md-12" style="padding:0;">
 						...
 						<div class="">
                             ...
                             <div class="col-md-2"></div>
 							<div class="col-md-3 form-group"> <div class="input-icon"><input type="text" class="form-control" name="emp_date" placeholder="Date" value="<?php if(isset($form) && isset($_GET['form_id']))echo $form['emp_date'];?>"></div>
 							</div>
                             <div class="col-md-2"></div>
 						</div>
 						<div class="clearfix"></div>
 						<div class="">
                             ...
                             <div class="col-md-2"></div>
 							<div class="col-md-3 form-group"> <div class="input-icon"><input type="text" class="form-control" name="hr_date" placeholder="Date" value="<?php if(isset($form) && isset($_GET['form_id']))echo $form['hr_date'];?>"></div>
 							</div>
                             <div class="col-md-2"></div>
 						</div>
 					</div>
