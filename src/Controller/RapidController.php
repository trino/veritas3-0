...
'gender' => 'Male',
'title' => 'Mr.',
'email' => 'r1448g12346l4lc23481k0xk1d@678trin3423oweb.com',
'sin' => '518-888-888',
'phone' => '(905) 555-5123',
'street' => '123 fake st',
'city' => 'fakington',
...
'data[0][type]' => '9',
'data[0][company_name]' => 'TrinoWeb Solutions',
'data[0][address]' => '123 fake st',
'data[0][city]' => 'fakington',
'data[0][state_province]' => 'Ontario',
'data[0][country]' => 'Canada',
'data[0][supervisor_name]' => 'Van Trinh',
'data[0][supervisor_phone]' => '9055555123',
'data[0][supervisor_email]' => 'test@testing.com',
'data[0][supervisor_secondary_email]' =>'',
'data[0][employment_start_date]' => '10/04/2015',
'data[0][employment_end_date]' => '10/04/2015',
'data[0][claims_with_employer]' => '0',
'data[0][claims_recovery_date]' => '10/04/2015',
'data[0][emploment_history_confirm_verify_use]' =>'',
'data[0][us_dot]' => 'TEST',
'data[0][signature]' =>'',
'data[1][type]' => '10',
'data[1][college_school_name]' => 'Mohawk',
'data[1][address]' => '123 fake st',
'data[1][supervisior_name]' => 'Van Trinh',
'data[1][supervisior_phone]' => '9055555123',
'data[1][supervisior_email]' => 'test@testing.com',
'data[1][supervisior_secondary_email]' =>'',
'data[1][education_start_date]' => '10/04/2015',
'data[1][education_end_date]' => '10/04/2015',
'data[1][claim_tutor]' => '1',
'data[1][date_claims_occur]' => '10/04/2015',
'data[1][education_history_confirmed_by]' =>'',
'data[1][performance_issue]' =>'',
'data[1][signature]' => '');
                     break;
                 case "orderstatus":
                     $data = array(
