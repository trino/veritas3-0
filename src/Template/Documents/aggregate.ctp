...
<form  id="form_tab8" method="post" action="/veritas3-0/documents/audits/1/15" class="form-horizontal">
    ...
    <table class="table-condensed table-striped table-bordered table-hover dataTable no-footer">
        <TR><Th>Client</Th><TD align="center"><?php echo $client->id;?></TD><TD><?php echo $client->company_name;?></TD><td><?php if($client->client_date)echo $client->client_date;else echo "No date available.";?></td></TR>
    </table>
