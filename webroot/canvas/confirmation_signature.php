...
$_GET['num']=1;?>
        ...
        <div class="col-sm-10" style="width: 700px;">
    		...
    		<div class="links" style="margin-top: 5px;">
    			...
    			<a href="javascript:void(0)" class="no-print" onclick='$("#test6").data("jqScribble").clear();$(this).parent().parent().find(".touched").val("0");$("#test<?php echo $_GET['num'];?>").data("jqScribble").clear();'><?= $strings["forms_clear"]; ?></a>
                <br />
