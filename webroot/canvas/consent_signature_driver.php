        ...
        <div class="col-sm-12" id="sig1">
    		...
    		<div class="links" style="margin-top: 5px;">
    			...
    			<a href="javascript:void(0)" onclick='$("#test3").data("jqScribble").clear();$(this).parent().parent().find(".touched").val("0");'>Clear</a> <a href="javascript:void(0)" onclick="save_signature('3');">Save</a>  			
                <br />
    		</div>
        </div>
