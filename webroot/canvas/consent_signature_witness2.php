...
<div class="col-sm-12" id="sig4">
    ...
    <div class="links" style="margin-top: 5px;">
        ...
        <a href="javascript:void(0)" onclick='$("#test6").data("jqScribble").clear();$(this).parent().parent().find(".touched").val("0");'><?= $strings["forms_clear"]; ?></a> <a href="javascript:void(0)" onclick="$(this).parent().parent().find('.touched').val('1');save_signature('6');"><?= $strings["forms_save"]; ?></a> <span class="saved6" style="color: green;"></span>
        <br/>
    </div>
</div>
